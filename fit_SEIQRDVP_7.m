function [mu1,kappa1,alpha1,gamma1,omega1] = fit_SEIQRDVP_7(C,R,D,Vaccination,Npop,E0,I0,V0,P0,time,guess,pIndex,start_delta,fit,varargin)
%% Inputparseer
p = inputParser();
