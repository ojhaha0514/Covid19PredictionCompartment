function [Q,R,D,T] = getMultipleWaves_1(guess,Npop,time,Confirmed,Recovered,Deaths,tStart1,tIndex,varargin)
%% varargin
...
%% Nested functions
    ...
    function [E,I,Q,R,D,newT] = computeWave(Active,Recovered,Deaths,E0,I0,Q0,R0,D0,time,tStart,tEnd,guess)
        ...
        [alpha1,beta1,gamma1,delta1,lambda1,kappa1] = ...
            fit_SEIQRDP_1(Active,Recovered,Deaths,Npop,E0,I0,time,guess,'Display','off');
        
        dt = 1/24; % time step
        newT = tStart:dt:tEnd;
        N = numel(newT);
        t = [0:N-1].*dt;
        [~,E,I,Q,R,D,~] = SEIQRDP_1(alpha1,beta1,gamma1,delta1,lambda1,kappa1,...
            Npop,E0,I0,Q0,R0,D0,t);
    end
