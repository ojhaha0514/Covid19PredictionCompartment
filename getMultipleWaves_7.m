function [I,Q,R,D,T] = getMultipleWaves_7(guess,Npop,time,Confirmed,Recovered,Deaths,Vaccination,tStart1,tIndex,pIndex,fit,est_day,varargin)
%% varargin
Confirmed = Confirmed';
Deaths = Deaths';
...
for ii=1:length(tIndex)-1
    ...
    [E1,I1,Q1,R1,D1,V1,P1,T1,para] = computeWave(Confirmed(indT),Recovered(indT),...
    Deaths(indT),Vaccination(indT),E0,I0,Q0,R0,D0,V0,P0,time1,time1(1),time1(end),guess,p,start_delta,fit);
...
[~,E2,I2,Q2,R2,D2,V2,P2] = SEIQRDVP_3(parameter(1),parameter(2),parameter(3),parameter(4),parameter(5),...
            Vaccination_pred1,Npop,E0,I0,Q0,R0,D0,V0,P0,time_pred,t_pred,p,start_delta,fit);
[~,E3,I3,Q3,R3,D3,V3,P3] = SEIQRDVP_3(0.75*parameter(1),parameter(2),parameter(3),parameter(4),parameter(5),...
            Vaccination_pred1,Npop,E0,I0,Q0,R0,D0,V0,P0,time_pred,t_pred,p,start_delta,fit);
[~,E4,I4,Q4,R4,D4,V4,P4] = SEIQRDVP_3(1.25*parameter(1),parameter(2),parameter(3),parameter(4),parameter(5),...
            Vaccination_pred1,Npop,E0,I0,Q0,R0,D0,V0,P0,time_pred,t_pred,p,start_delta,fit);
...
%% Nested functions
    ...
    function [E,I,Q,R,D,V,P,newT,para] = computeWave(Confirmed,Recovered,Deaths,Vaccination,E0,I0,Q0,R0,D0,V0,P0,...
        ...
        [mu1,kappa1,alpha1,gamma1,omega1] = ...
            fit_SEIQRDVP_7(Confirmed,Recovered,Deaths,Vaccination,Npop,E0,I0,V0,P0,time,guess,p,start_delta,fit,'Display','off');
        ...
        N = numel(newT);
        t = [0:N-1].*dt;
        [~,E,I,Q,R,D,V,P] = SEIQRDVP_3(mu1,kappa1,alpha1,gamma1,omega1,...
            Vaccination,Npop,E0,I0,Q0,R0,D0,V0,P0,time,t,p,start_delta,fit);
    end
