function [Q,R,D,T] = getMultipleWaves_3(guess,Npop,time,Confirmed,Recovered,Deaths,Vaccination,tStart1,tIndex,pIndex,fit,est_day,varargin)
%% varargin
Confirmed = Confirmed';
Deaths = Deaths';
...
%% Nested functions
    ...
    function [E,I,Q,R,D,V,P,newT,para] = computeWave(Confirmed,Recovered,Deaths,Vaccination,E0,I0,Q0,R0,D0,V0,P0,...
        ...
        [mu1,kappa1,alpha1,gamma1,omega1] = ...
            fit_SEIQRDVP_3(Confirmed,Recovered,Deaths,Vaccination,Npop,...
            E0,I0,V0,P0,time,guess,p,start_delta,fit,'Display','off');
