function [S,E,I,Q,R,D,V,U,P] = SEIQRDVUP_2(mu,kappa,alpha,gamma,omega,Vaccination,Npop,E0,I0,Q0,R0,D0,V0,U0,P0,time,t,pIndex,start_delta,fit)
%% Initial conditions
N = numel(t);
...
Y(1,1) = Npop-Q0-R0-D0-E0-I0-V0-U0-P0;
Y(2,1) = E0;
Y(3,1) = I0;
Y(4,1) = Q0;
Y(5,1) = R0;
